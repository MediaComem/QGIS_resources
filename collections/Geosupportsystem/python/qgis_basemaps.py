...
sources.append(["connections-xyz","Swisstopo vivid", "", "", "Requires MapTiler API Key", "https://api.maptiler.com/maps/ch-swisstopo-lbm-vivid/%7Bz%7D/%7Bx%7D/%7By%7D.png?key={your_API_key}", "", "20", "0"])
